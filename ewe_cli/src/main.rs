...
fn print_count_table(counts: &std::collections::BTreeMap<String, usize>) {
...
fn run_stats(
    ...
    let mut synsets_by_pos: std::collections::BTreeMap<String, usize> = std::collections::BTreeMap::new();
    let mut synset_rel_counts: std::collections::BTreeMap<String, usize> = std::collections::BTreeMap::new();
    let mut roots_by_pos: std::collections::BTreeMap<String, usize> = std::collections::BTreeMap::new();
    ...
    let mut entries_by_pos: std::collections::BTreeMap<String, usize> = std::collections::BTreeMap::new();
    let mut sense_rel_counts: std::collections::BTreeMap<String, usize> = std::collections::BTreeMap::new();
